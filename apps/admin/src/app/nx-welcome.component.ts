...
@Component({
  selector: 'lnzsoftware-nx-welcome',
  template: `
    <!--
     * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      ...
      <div class="container">
        ...
        <div id="middle-content">
          ...
          <div id="other-links">
            ...
            <a class="button-pill rounded shadow nx-console" href="https://plugins.jetbrains.com/plugin/21060-nx-console" target="_blank" rel="noreferrer">
              <svg fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
